<template>
        ...
        <v-main>
            <div class="d-flex h-screen align-center justify-center">
                <div class="d-flex flex-column text-grey-darken-2">
                    ...
                    <div class="text-caption">Sistem Canteen RS PKU Muhammadiyah Gamping</div>
                    ...
                    <v-btn @click="onLoading(), onLogin()" class="text-body-1" color="teal">Login</v-btn>
    ...
    <v-layout>
        <v-footer class="mt-n10 text-body-2 justify-center text-grey-darken-2">&#169; Kantin Barokah 2023</v-footer>
    </v-layout>
</template>
<script>
    ...
    methods: {
        ...
        async onLogin() {
            try {
                ...
                const response = await axios.post(useEnvStore().apiUrl + 'login/', auth)
